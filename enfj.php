...
?>
    ...
    <div class="page-header">
        <h3 class="section__title-center about__title">ENFJ</h3>
    </div>
            ...
            <div class="accordion__container">
                <div class="accordion__item">
                    <header class="accordion__header">
                        ...
                        <h3 class="accordion__title">What's an ENFJ?</h3>
                    </header>
                ...
                <div class="accordion__item">
                    ...
                    <div class="accordion__content">
                        <p class="accordion__description">
                            Strenghts: Receptive, reliable, passionate, altruistic <br>
                            Weaknesses: Unrealistic, intense, overly empathetic, condescending
                        </p>
                    </div>
                </div>
                ...
                <div class="accordion__item">
                    ...
                    <div class="accordion__content">
                        <p class="accordion__description">
                            Top careers for the ENFJ include:<br>
Social Worker,
Reporter,
Author,
College Instructor,
