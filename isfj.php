...
?>
    ...
    <div class="page-header">
        <h3 class="section__title-center about__title">ISFJ</h3>
    </div>
            ...
            <div class="accordion__container">
                <div class="accordion__item">
                    <header class="accordion__header">
                        ...
                        <h3 class="accordion__title">What's an ISFJ?</h3>
                    </header>
                ...
                <div class="accordion__item">
                    ...
                    <div class="accordion__content">
                        <p class="accordion__description">
                            Strenghts: Supportive, reliable, observant, enthusiastic, hardworking. <br>
                            Weaknesses: overly humble, overcommitted, taking things personally.
                        </p>
                    </div>
                </div>
                ...
                <div class="accordion__item">
                    ...
                    <div class="accordion__content">
                        <p class="accordion__description">
                            Teacher Assistant, Information Clerk, Human Resources Specialist, Biomedical Engineer, Firefighter
                        </p>
                    </div>
                </div>
