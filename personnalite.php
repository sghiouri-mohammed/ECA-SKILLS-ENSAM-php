...
<div class="container">
    ...
    <p>The following test is designed to measure your MBTI Personality type. <br>
...
others” <br> </p>
    <ol style="margin-top: 50px;">
        <li><strong>At an event, do you:</strong><br>
            <div class="radio">
                <label>
        ...
        <li><strong>Do you like to:</strong><br>
            <div class="radio">
                <label>
    ...
    <button id="submit" class="btn btn-primary btn-lg button button--flex" style="margin-top: 20px;">Calculate Results <i class="ri-arrow-right-down-line button__icon"></i></button>
